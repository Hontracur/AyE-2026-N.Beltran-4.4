...
Console.WriteLine();
Console.WriteLine("Ingrese la coordenada (fila, columna) para obtener el elemento correspondiente (ejemplo: 1,2):");
Console.WriteLine("");
...
Console.WriteLine("Ingrese 16 números separados por espacios (ejemplo: 1 2 3 4 5...).");
Console.WriteLine("");
...
Console.WriteLine("Escribir un programa que busque un numero ingresado por el usuario y devuelva la cantidad de veces que aparece en la matriz.");
Console.WriteLine("");
